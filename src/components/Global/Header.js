...
class Header extends Component {
    ...
    render() {
        const { isOpen } = this.state;
        const { isMobile, isTablet, siteTitle } = this.props;
        return (
            <header className={styles.Header__Wrapper}>
                <div className={styles.Logo__Container}><a href="/" className={styles.Logo__Img}>{siteTitle}</a></div>
                ...
                <nav className={cx(styles.Navbar, {'OPEN__NAV': isOpen})}>
                    <ul className={styles.Navbar__List}>
                        ...
                        <li className={styles.Navbar__List_Item}>
                            <Link to="/projects" onClick={this.toggleMenu}>Projects</Link>
                        </li>
                        <li className={styles.Navbar__List_Item}>
